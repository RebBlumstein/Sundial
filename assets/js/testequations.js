...
result += "Sunrise: " + TimeFromFrac(date, AstSunrise(date, latitude, longitude, timezone)) + "<br>";
result += "Sunset: " + TimeFromFrac(date, AstSunset(date, latitude, longitude, timezone)) + "<br>";
